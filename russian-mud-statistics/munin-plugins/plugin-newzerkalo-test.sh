...
# LC_CTYPE=koi8-r
# echo Ktoto est
cat /var/www/zerkalo.kharkov.org/who.html | grep -a "Всего" | awk '{l=length($3); if (l==11) print "zmud-players.value " 0+$6; else print "zmud-players.value " $4; t=0+$6; print "TEST t=" t}'
fi
